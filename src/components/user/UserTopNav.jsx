    ...
    <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-6 shrink-0">
      <div className="flex items-center gap-12">
        ...
        <Link href="/" className="flex-shrink-0 flex items-center">
          <span className="font-serif text-2xl font-bold tracking-tight text-blue-700">
            ArtHub
          </span>
        </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative hidden md:block w-64">
          ...
          <input
            ...
            className="w-full bg-gray-50 border-none rounded-full pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 text-gray-700"
          />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button 
              className="w-8 h-8 rounded-full overflow-hidden border border-gray-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
